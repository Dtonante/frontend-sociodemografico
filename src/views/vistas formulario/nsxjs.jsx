...
const VistaDatosUsuario = () => {
  ...
  const handleInputChange = (event) => {
    ...
    if (
      ...
      // Convertir a mayúsculas para campos que permiten letras y números
      setFormData({
        ...formData,
        [name]: value.toUpperCase(),
      });
    } else {
      // Para otros campos, no hacemos ninguna modificación
      setFormData({
        ...formData,
        [name]: value,
      });
  ...
  const handleKeyPresss = (event, fieldName) => {
    ...
    const validationRules = {
      ...
      "documento": {
        ...
        "Documento Nacional de Identificación de otro país (DNI)": /^[A-Za-z0-9]*$/, 
        ...
        <CardContent sx={{ padding: "30px" }}>
          <form onSubmit={manejarEnvio}>
            ...
            <TextField
              ...
              fullWidth
              sx={{ mb: 2 }}
              onBlur={handleBlur} // Asegúrate de que se ejecute la validación al perder el foco
